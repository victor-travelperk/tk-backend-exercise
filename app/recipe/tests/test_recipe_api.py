...
def create_sample_recipe(
    name="Krusty krab burguer", description="Best in bikini botton"
):
...
class TestRecipeApi(TestCase):
    ...
    def test_list_recipes_with_filter(self):
        recipe1 = create_sample_recipe(name="Big Mac")
    ...
    def test_update_recipe_successful(self):
        recipe = create_sample_recipe(
            name="Burrito light", description="Burrito for a quick bite"
        )
